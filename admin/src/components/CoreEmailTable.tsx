...
const CoreEmailTable = () => {
  ...
  const headers = [
    {
      name: formatMessage({ id: getTranslation("table.header.coreEmailType") }),
      value: "name",
    },
  ];
  const coreEmailTypes = [
    {
      ...
      name: formatMessage({
        id: getTranslation("emailTypes.user-address-confirmation"),
      }),
    },
    {
              ...
              <Td>
                <Flex justifyContent="end" gap="8px">
                  <IconButton
                    onClick={() =>
                      navigate({
                        pathname: getUrl(`core/${coreEmailType.coreEmailType}`),
                      })
                    }
                    label={formatMessage({
                      id: getTranslation("table.action.edit"),
                    })}
                  >
                    <Pencil />
                  </IconButton>
