...
const CoreEmailTable = () => {
  ...
  const headers = [
    { name: formatMessage({ id: getTrad("table.header.coreEmailType") }), value: "name" },
  ];
  const coreEmailTypes = [
    {
      coreEmailType: "user-address-confirmation",
      name: formatMessage({ id: getTrad("emailTypes.user-address-confirmation") }),
    },
    {
      coreEmailType: "reset-password",
      name: formatMessage({ id: getTrad("emailTypes.reset-password") }),
    },
  ];
              ...
              <Td>
                <Flex justifyContent="end" gap="8px">
                  <IconButton
                    ...
                    label={formatMessage({ id: getTrad("table.action.edit") })}
                  >
                    <Pencil />
                  </IconButton>
                </Flex>
