...
export default {
            ...
            resetPassword: {
              ...
              mergeTags: {
                ...
                token: {
                  ...
                  value: "{{= TOKEN }}",
                  sample:
                    "corresponds-to-the-token-generated-to-be-able-to-reset-the-password",
                },
                url: {
                  name: "URL",
                  value: "{{= URL }}",
            ...
            addressConfirmation: {
              ...
              mergeTags: {
                ...
                code: {
                  ...
                  value: "{{= CODE }}",
                  sample:
                    "corresponds-to-the-CODE-generated-to-be-able-confirm-the-user-email",
                },
                url: {
                  name: "URL",
                  value: "{{= URL }}",
   ...
   *
   * @default "strapi-pdf-designer"
   */
  pluginName: "strapi-pdf-designer",
};
