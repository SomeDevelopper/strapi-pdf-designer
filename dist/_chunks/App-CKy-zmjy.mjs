...
import { p as pluginId, a as pluginName } from "./index-DcHgfIQX.mjs";
  ...
  const saveDesign = async () => {
    ...
    try {
      ...
      if (templateId === "new" && response && templateId !== response.id) {
        navigate(`/plugins/${pluginId}/design/${response.templateReferenceId}`);
      }
    } catch (err) {
      console.error(err);
...
//# sourceMappingURL=App-CKy-zmjy.mjs.map
