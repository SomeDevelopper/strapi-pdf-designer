...
import { p as pluginId, a as pluginName } from "./index-Cw_PRB2O.mjs";
  ...
  return /* @__PURE__ */ jsx(Page.Main, { children: /* @__PURE__ */ jsxs(DesignSystemProvider, { children: [
    ...
    /* @__PURE__ */ jsx(Layouts.Content, { children: /* @__PURE__ */ jsx(
      Tabs.Root,
      {
        ...
        children: /* @__PURE__ */ jsx(Tabs.List, { "aria-label": "Switch between custom email designs & core email designs", children: /* @__PURE__ */ jsx(Tabs.Trigger, { value: "customEmailTemplates", children: translate("PDFTypes.custom.tab.label") }) })
      }
    ) })
  ] }) });
};
...
//# sourceMappingURL=App-DMGjppu4.mjs.map
