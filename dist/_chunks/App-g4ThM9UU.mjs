...
import { faCopy, faFileExport, faFileImport } from "@fortawesome/free-solid-svg-icons";
...
import { p as pluginId, a as pluginName } from "./index-DTbGpoV5.mjs";
...
const FooterWrapper = styled$1.div`
  display: flex;
  align-items: center;
  ...
  padding: 0 10px;
`;
const FooterButtonsWrapper = styled$1.div`
  display: flex;
  flex-direction: row;
  button {
    margin-right: 0.5rem;
...
const HomePage = () => {
  ...
  const handleTemplatesExport = async () => {
    ...
    let a2 = document.createElement("a");
    a2.href = dataStr;
    a2.download = `${pluginId}-templates_${dayjs().unix()}.json`;
    a2.click();
  };
  const handleFileChange = (event) => {
    if (!event) return;
  ...
  return /* @__PURE__ */ jsx(Page.Main, { children: /* @__PURE__ */ jsxs(DesignSystemProvider, { children: [
    /* @__PURE__ */ jsx(
      Dialog.Root,
      {
    ...
    /* @__PURE__ */ jsx(
      Layouts.Header,
      {
        navigationAction: /* @__PURE__ */ jsx(Link, { startIcon: /* @__PURE__ */ jsx(ArrowLeft, {}), onClick: () => navigate({ pathname: getUrl() }), children: getMessage("goBack") }),
    ...
    /* @__PURE__ */ jsxs(Layouts.Content, { children: [
      /* @__PURE__ */ jsxs(
        Tabs.Root,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(Tabs.List, { "aria-label": "Switch between custom email designs & core email designs", children: [
              /* @__PURE__ */ jsx(Tabs.Trigger, { value: "customEmailTemplates", children: translate("PDFTypes.custom.tab.label") }),
              /* @__PURE__ */ jsx(Tabs.Trigger, { value: "coreEmailTemplates", children: translate("PDFTypes.core.tab.label") })
            ] }),
            /* @__PURE__ */ jsx(
              Tabs.Content,
              {
            ...
            /* @__PURE__ */ jsx(Tabs.Content, { children: /* @__PURE__ */ jsxs(
              Table,
              {
                colCount: emailTemplatesHeaders.length,
                rowCount: emailTemplates.length,
                footer: /* @__PURE__ */ jsx(TFooter, { icon: /* @__PURE__ */ jsx(Plus, {}), onClick: () => navigate({ pathname: getUrl("design/new") }), children: "Add another field to this collection type" }),
                children: [
                  /* @__PURE__ */ jsx(Thead, { children: /* @__PURE__ */ jsxs(Tr, { children: [
                    emailTemplatesHeaders.map((header) => /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: header.name }) }, header.value)),
                    /* @__PURE__ */ jsx(Th, { children: /* @__PURE__ */ jsx(Typography, { variant: "sigma", children: getMessage("table.actions") }) })
                  ] }) }),
                  /* @__PURE__ */ jsx(Tbody, { children: emailTemplates.map((template, index) => /* @__PURE__ */ jsxs(Tr, { children: [
                    /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: template.name }) }),
                    /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: template.templateReferenceId }) }),
                    /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800" }) }),
                    /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: template.createdAt }) }),
                    /* @__PURE__ */ jsx(Td, { children: /* @__PURE__ */ jsxs(Flex, { children: [
                      ...
                      /* @__PURE__ */ jsx(
                        IconButton,
                        {
                          ...
                          children: /* @__PURE__ */ jsx(Duplicate, { fill: "#000000" })
                        }
                      ),
                      /* @__PURE__ */ jsx(
                        IconButton,
      ...
      /* @__PURE__ */ jsx(FooterWrapper, { children: activeTab === "customEmailTemplates" && /* @__PURE__ */ jsxs(FooterButtonsWrapper, { children: [
        emailTemplates?.length > 0 && /* @__PURE__ */ jsx(
          IconButton,
          {
            onClick: () => handleTemplatesExport(),
            color: "success",
            label: getMessage("designer.exportTemplates"),
            children: /* @__PURE__ */ jsx(FontAwesomeIcon, { icon: faFileExport })
          }
        ),
        /* @__PURE__ */ jsx(
          IconButton,
          {
            ...
            children: /* @__PURE__ */ jsx(FontAwesomeIcon, { icon: faFileImport })
          }
        ),
        /* @__PURE__ */ jsx("span", { style: { display: "none" }, children: /* @__PURE__ */ jsx("input", { type: "file", ref: emailTemplatesFileSelect, onChange: handleFileChange }) })
      ] }) })
    ] })
  ] }) });
};
...
const Designer = ({ isCore = false }) => {
  ...
  return /* @__PURE__ */ jsxs(Page.Main, { children: [
    ...
    /* @__PURE__ */ jsx(DesignerContainer, { children: /* @__PURE__ */ jsxs(DesignSystemProvider, { children: [
      /* @__PURE__ */ jsxs(Header, { children: [
        ...
        /* @__PURE__ */ jsxs(Bar, { children: [
          ...
          /* @__PURE__ */ jsxs(Box, { padding: 0, style: { width: isCore ? 450 : "100%", paddingRight: 10 }, children: [
          ...
          /* @__PURE__ */ jsx(Button, { onClick: saveDesign, color: "success", children: getMessage("designer.action.saveTemplate") })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(
        Tabs.Root,
...
const App = () => {
  ...
  return /* @__PURE__ */ jsx(PluginViewWrapper, { children: /* @__PURE__ */ jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsx(Route, { path: `designn/:templateId`, element: /* @__PURE__ */ jsx(Designer$1, {}) }),
    /* @__PURE__ */ jsx(Route, { path: `core/:coreEmailType`, element: /* @__PURE__ */ jsx(Designer$1, { isCore: true }) }),
