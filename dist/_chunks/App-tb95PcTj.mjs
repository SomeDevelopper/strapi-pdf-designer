...
import { p as pluginId, a as pluginName } from "./index-CdaQRs0F.mjs";
    ...
    /* @__PURE__ */ jsx(DesignerContainer, { children: /* @__PURE__ */ jsxs(DesignSystemProvider, { theme: darkTheme, children: [
      /* @__PURE__ */ jsxs(Header, { children: [
        ...
        /* @__PURE__ */ jsxs(Bar, { children: [
          ...
          /* @__PURE__ */ jsx(Box, { style: { width: "100%", maxWidth: "100px" }, children: /* @__PURE__ */ jsx(Button, { onClick: () => preview(templateData?.templateReferenceId), style: { marginTop: "19px", height: "38px", width: "100%" }, children: translate("preview") }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(
        Tabs.Root,
...
//# sourceMappingURL=App-tb95PcTj.mjs.map
