...
const index = require("./index-CIk-YzZH.js");
...
const CustomEmailTable = ({ data = [], reload }) => {
  ...
  const emailTemplatesHeaders = [
    ...
    { name: formatMessage({ id: getTrad("table.header.enabled") }), value: "enabled" },
        ...
        designSystem.Table,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: data.map((entry, idx) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: entry.documentId }) }),
...
exports.App = App;
//# sourceMappingURL=App-08q1iONa.js.map
