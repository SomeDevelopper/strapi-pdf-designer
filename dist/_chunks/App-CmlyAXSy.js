...
const index = require("./index-D5sFPo8y.js");
...
const HomePage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Page.Main, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.DesignSystemProvider, { theme: designSystem.darkTheme, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Dialog.Root,
      {
...
const Designer = ({ isCore = false }) => {
  ...
  const saveDesign = async () => {
    ...
    try {
      ...
      if (templateId === "new" && response && templateId !== response.templateCreate.id) {
        navigate(`/plugins/${index.pluginId}/design/${response.templateCreate.templateReferenceId}`);
      }
    } catch (err) {
      console.error(err);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Page.Main, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(DesignerContainer, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.DesignSystemProvider, { theme: designSystem.darkTheme, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(Header, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(Bar, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 0, style: { width: isCore ? 450 : "60%", paddingRight: 10 }, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { required: true, children: [
          ...
          templateData && templateData.templateReferenceId !== void 0 ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { style: { width: "100%", maxWidth: "100px" }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => preview(templateData.templateReferenceId), style: { marginTop: "19px", height: "38px", width: "100%" }, children: translate("preview") }) }) : null
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Tabs.Root,
...
exports.App = App;
//# sourceMappingURL=App-CmlyAXSy.js.map
