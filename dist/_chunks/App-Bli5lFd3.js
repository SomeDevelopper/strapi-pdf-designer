...
const index = require("./index-CiNL5-J1.js");
...
const Designer = ({ isCore = false }) => {
  ...
  const preview = () => {
    const templateId2 = 19;
    const baseUrl = window.location.origin;
    const pdfUrl = `${baseUrl}/pdf-designer-5/generate-pdf/${templateId2}`;
    window.open(pdfUrl);
  };
    ...
    /* @__PURE__ */ jsxRuntime.jsx(DesignerContainer, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.DesignSystemProvider, { theme: designSystem.darkTheme, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(Header, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(Bar, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { style: { width: "100%", maxWidth: "100px" }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => preview(), style: { marginTop: "19px", height: "38px", width: "100%" }, children: translate("preview") }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Tabs.Root,
...
exports.App = App;
//# sourceMappingURL=App-Bli5lFd3.js.map
