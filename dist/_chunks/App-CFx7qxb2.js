...
const index = require("./index-B2dumUKO.js");
...
const getUrl = (to) => to ? `/plugins/${index.pluginId}/${to}` : `/plugins/${index.pluginId}`;
...
const getMessage = (input, defaultMessage = "", inPluginScope = true) => {
  ...
  return formatMessage(
    {
      id: `${inPluginScope ? index.pluginId : "app.components"}.${formattedId}`,
      defaultMessage
    },
    input?.props || void 0
  );
...
const getTemplatesData = async () => {
  const { data } = await axios.get(`/${index.pluginName}/templates`);
...
const getFullEditorConfig = async () => {
  const { data } = await axios.get(`/${index.pluginName}/config`);
  return data;
};
const getTemplateById = async (id) => {
  const { data } = await axios.get(`/${index.pluginName}/templates/${id}`);
  return data;
};
const getCoreTemplate = async (coreEmailType) => {
  const { data } = await axios.get(`/${index.pluginName}/core/${coreEmailType}`);
  return data;
};
const createTemplate = async (templateId, data) => {
  const { data: response } = await axios.post(`/${index.pluginName}/templates/${templateId}`, data);
  return response;
};
const updateCoreTemplate = async (coreEmailType, data) => {
  const { data: response } = await axios.post(`/${index.pluginName}/core/${coreEmailType}`, data);
  return response;
};
const duplicateTemplate = async (id) => {
  const { data } = await axios.post(`/${index.pluginName}/templates/duplicate/${id}`);
  return data;
};
const deleteTemplate = async (id) => {
  try {
    await axios.delete(`/${index.pluginName}/templates/${id}`);
    return { success: true };
  } catch (error) {
...
const downloadTemplate = async (id, type2) => {
  const { data, headers } = await axios.get(`/${index.pluginName}/download/${id}?type=${type2}`, {
    responseType: "blob"
  });
...
var IconContext = React__namespace.default.createContext && /* @__PURE__ */ React__namespace.default.createContext(DefaultContext);
...
function Tree2Element(tree) {
  return tree && tree.map((node, i2) => /* @__PURE__ */ React__namespace.default.createElement(node.tag, _objectSpread({
    key: i2
  }, node.attr), Tree2Element(node.child)));
}
function GenIcon(data) {
  return (props) => /* @__PURE__ */ React__namespace.default.createElement(IconBase, _extends({
...
function IconBase(props) {
  var elem = (conf) => {
    ...
    }), title && /* @__PURE__ */ React__namespace.default.createElement("title", null, title), props.children);
  };
  return IconContext !== void 0 ? /* @__PURE__ */ React__namespace.default.createElement(IconContext.Consumer, null, (conf) => elem(conf)) : elem(DefaultContext);
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: loading && /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "beta", style: { marginTop: "20px" }, children: formatMessage({ id: getTrad("pleaseWait") }) })
      ]
    }
  ) });
};
const ImportExportActions = ({ data = [], reload, handleTemplatesExport }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Dialog.Root,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Header, { children: formatMessage({ id: getTrad("confirm.title") }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Body, { icon: /* @__PURE__ */ jsxRuntime.jsx(icons.CloudUpload, { width: 50, height: 50 }), children: formatMessage({ id: getTrad("confirm.import.message") }) }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { style: { padding: "30px 0px 10px" }, gap: "14px", justifyContent: "end", children: [
      data?.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => handleTemplatesExport(), color: "success", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Download, {}), children: formatMessage({ id: getTrad("designer.exportTemplates") }) }),
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.Button,
        {
          onClick: () => {
...
const CustomEmailTable = ({ data = [], reload }) => {
  ...
  const handleTemplatesExport = async () => {
    ...
    a2.href = dataStr;
    a2.download = `email_templates_${dayjs__default.default().unix()}.json`;
    a2.click();
  };
  const emailTemplatesHeaders = [
    ...
    { name: formatMessage({ id: getTrad("table.header.actions") }), value: "actions" }
  ];
  if (data.length === 0) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Dialog.Root,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Header, { children: formatMessage({ id: getTrad("confirm.title") }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Body, { icon: /* @__PURE__ */ jsxRuntime.jsx(LuCopyCheck, { size: "30px" }), children: formatMessage({ id: getTrad("confirm.duplicate.message") }) }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Footer, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Root, { open: showDeleteModal, onOpenChange: () => setShowDeleteModal((s2) => !s2), children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Header, { children: formatMessage({ id: getTrad("confirm.title") }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Body, { icon: /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, { width: "30px" }), children: formatMessage({ id: getTrad("confirm.delete.message") }) }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Footer, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 3, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Table,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tr, { children: emailTemplatesHeaders.map((header) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { style: { fontWeight: "bold" }, variant: "sigma", children: header.name }) }, header.name)) }) }),
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: "10px", justifyContent: "end", children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.IconButton,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsx(BsFiletypeHtml, { size: 16 })
                  }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.IconButton,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsx(BsFiletypeJson, { size: 16 })
                  }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.IconButton,
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.IconButton,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsx(FaHashtag, { size: 16 })
                  }
                ),
...
const FooterWrapper = styled__default.default.div`
  ...
  padding: 0 10px;
`;
const FooterButtonsWrapper = styled__default.default.div`
  display: flex;
  flex-direction: row;
  button {
    margin-right: 0.5rem;
...
const HomePage = () => {
  ...
  const handleTemplateDeletion = React.useCallback(async () => {
    if (!deleteId) return;
    try {
  ...
  const handleTemplatesExport = async () => {
    ...
    let a2 = document.createElement("a");
    a2.href = dataStr;
    a2.download = `${index.pluginId}-templates_${dayjs__default.default().unix()}.json`;
    a2.click();
  };
  const handleFileChange = (event) => {
    if (!event) return;
  ...
  const handleTemplatesImport = async () => {
    try {
      ...
      let newTemplates = [...emailTemplates, ..._importedTemplates].map((data) => {
        ...
        data.createdAt = dayjs__default.default(data.createdAt).format(dateFormat);
        return data;
      });
      newTemplates = lodash.uniqBy(newTemplates, (_2) => _2.id);
  ...
  const emailTemplatesHeaders = [
    ...
    { name: getMessage("table.actions"), value: "actions" }
  ];
  return /* @__PURE__ */ jsxRuntime.jsx(Page.Main, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.DesignSystemProvider, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Dialog.Root,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Body, { children: /* @__PURE__ */ jsxRuntime.jsx(icons.Stack, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", children: getMessage("notification.importTemplate") }) }) }) }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Footer, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Cancel, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => setImportConfirmationModal(false), variant: "tertiary", children: "Cancel" }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "danger-light", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, {}), onClick: () => handleTemplatesImport(), children: "Confirm" })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Dialog.Root,
      {
        isOpen: !lodash.isNil(duplicateConfirmationModal) && duplicateConfirmationModal !== false,
        title: getMessage("pleaseConfirm"),
        onClose: () => setDuplicateConfirmationModal(false),
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Body, { children: /* @__PURE__ */ jsxRuntime.jsx(icons.Stack, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", children: getMessage("questions.sureToDuplicate") }) }) }) }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Footer, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Cancel, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => setDuplicateConfirmationModal(false), variant: "tertiary", children: "Cancel" }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Action, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "danger-light", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Duplicate, {}), onClick: () => handleTemplateDuplication(), children: "Confirm" }) })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Dialog.Root,
      {
        open: !lodash.isNil(deleteConfirmationModal) && deleteConfirmationModal !== false,
        toggleModal: () => setDeleteConfirmationModal(false),
        onClose: () => setDeleteConfirmationModal(false),
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Content, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Body, { children: /* @__PURE__ */ jsxRuntime.jsx(icons.Stack, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", children: getMessage("questions.sureToDelete") }) }) }) }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog.Footer, { children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Cancel, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => setDeleteConfirmationModal(false), variant: "tertiary", children: "Cancel" }) }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Dialog.Action, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "danger-light", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, {}), onClick: () => handleTemplateDeletion(), children: "Confirm" }) })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      Layouts.Header,
      {
        navigationAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Link, { startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.ArrowLeft, {}), onClick: () => navigate({ pathname: getUrl() }), children: getMessage("goBack") }),
        primaryAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, {}), onClick: () => navigate({ pathname: getUrl(`design/new`) }), children: getMessage("newTemplate") }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(Layouts.Content, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Tabs.Root,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.List, { "aria-label": "Switch between custom email designs & core email designs", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Trigger, { value: "customEmailTemplates", children: translate("PDFTypes.custom.tab.label") }) }),
            /* @__PURE__ */ jsxRuntime.jsx(
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Content, { value: "customEmailTemplates", children: /* @__PURE__ */ jsxRuntime.jsxs(
              designSystem.Table,
              {
                colCount: emailTemplatesHeaders.length + 1,
                rowCount: emailTemplates.length,
                footer: /* @__PURE__ */ jsxRuntime.jsx(designSystem.TFooter, { icon: /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, {}), onClick: () => navigate({ pathname: getUrl("design/new") }), children: "Add another field to this collection type" }),
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Thead, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
                    emailTemplatesHeaders.map((header) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { variant: "sigma", children: [
                      header.name,
                      " yest"
                    ] }) }, header.name)),
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Th, {})
                  ] }) }),
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tbody, { children: emailTemplates.map((template, index2) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: template.name }) }),
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: template.id }) }),
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: template.templateReferenceId }) }),
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800" }) }),
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral800", children: template.createdAt }) }),
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.IconButton,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntime.jsx(icons.Duplicate, { fill: "#000000" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.IconButton,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntime.jsx(reactFontawesome.FontAwesomeIcon, { icon: freeSolidSvgIcons.faCopy })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 1, children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.IconButton,
      ...
      /* @__PURE__ */ jsxRuntime.jsx(FooterWrapper, { children: activeTab === "customEmailTemplates" && /* @__PURE__ */ jsxRuntime.jsxs(FooterButtonsWrapper, { children: [
        emailTemplates?.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.IconButton,
          {
            onClick: () => handleTemplatesExport(),
            color: "success",
            label: getMessage("designer.exportTemplates"),
            children: /* @__PURE__ */ jsxRuntime.jsx(reactFontawesome.FontAwesomeIcon, { icon: freeSolidSvgIcons.faFileExport })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.IconButton,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(reactFontawesome.FontAwesomeIcon, { icon: freeSolidSvgIcons.faFileImport })
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { display: "none" }, children: /* @__PURE__ */ jsxRuntime.jsx("input", { type: "file", ref: emailTemplatesFileSelect, onChange: handleFileChange }) })
      ] }) })
    ] })
  ] }) });
};
...
const Designer = ({ isCore = false }) => {
  ...
  React.useState(null);
  React.useState({ ...defaultEditorAppearance });
  React.useState({ ...defaultEditorTools });
  ...
  const saveDesign = async () => {
    ...
    try {
      ...
      if (templateId === "new" && response && templateId !== response.id) {
        navigate(`/plugins/${index.pluginId}/design/${response.id}`);
      }
    } catch (err) {
      console.error(err);
      ...
      if (errorMessage) {
        ...
        toggleNotification({
          type: "danger",
          title: "Error",
          message: `${index.pluginId}.notification.error`
        });
      }
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Page.Main, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(Page.Title, { children: translate("page.design.title") }),
    /* @__PURE__ */ jsxRuntime.jsx(DesignerContainer, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.DesignSystemProvider, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(Header, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(Bar, { children: [
          !isCore && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 0, style: { width: 260, paddingRight: 10 }, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { required: true, error: errorRefId, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.Field.Input,
              {
                ...
                onChange: (e2) => setTemplateData((state) => ({
                  ...state || {},
                  templateReferenceId: e2.target.value === "" ? "" : lodash.isFinite(parseInt(e2.target.value)) ? parseInt(e2.target.value) : state?.templateReferenceId ?? ""
                }))
              }
            ),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Error, {})
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 0, style: { width: isCore ? 450 : "100%", paddingRight: 10 }, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Field.Root, { required: true, children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: translate("input.placeholder.subject") }),
            /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.Field.Input,
              {
                onChange: (value) => {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: saveDesign, color: "success", children: getMessage("designer.action.saveTemplate") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Tabs.Root,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tabs.List, { "aria-label": "Email designer tabs", children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Trigger, { value: "html", children: getMessage("designer.version.html") }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Trigger, { value: "text", children: getMessage("designer.version.text") })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { style: {
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Content, { value: "html", children: /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Box,
                {
                  style: {
                    flexGrow: 1,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs.Content, { value: "text", children: /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Textarea,
                {
                  name: "textarea",
...
const HowToPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral100", padding: 4, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingBottom: 4, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { alignItems: "center", gap: "16px", children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Link, { to: "#", onClick: handleGoBack, style: { display: "flex", alignItems: "center", textDecoration: "none" }, children: [
        /* @__PURE__ */ jsxRuntime.jsx(icons.ArrowLeft, {}),
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { marginLeft: "8px" }, children: getMessage("goBack") })
      ] }) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "beta", tag: "h2", marginTop: 2, children: getMessage("howToUse") }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral600", children: getMessage("howToUse.content") })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 4, background: "neutral0", hasRadius: true, shadow: "tableShadow", children: /* @__PURE__ */ jsxRuntime.jsx(
...
const HowToPage$1 = React.memo(HowToPage);
const App = () => {
  const PluginViewWrapper = styled__default.default.div`
    min-height: 100vh;
  `;
  return /* @__PURE__ */ jsxRuntime.jsx(PluginViewWrapper, { children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: `how-to`, element: /* @__PURE__ */ jsxRuntime.jsx(HowToPage$1, {}) }),
    /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: "*", element: /* @__PURE__ */ jsxRuntime.jsx(admin.Page.Error, {}) })
  ] }) });
};
exports.App = App;
//# sourceMappingURL=App-CFx7qxb2.js.map
