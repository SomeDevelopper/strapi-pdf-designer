  ...
  const generatePdf = async (pdfTemplate2 = {}, data = {}, myFooter = {}) => {
    ...
    try {
      ...
      if ((!bodyText || !bodyText.length) && bodyHtml && bodyHtml.length)
        bodyText = htmlToText.htmlToText(bodyHtml, { wordwrap: 130, trimEmptyLines: true, uppercaseHeadings: false });
      pdfTemplate2 = {
        ...pdfTemplate2,
      ...
      const files = { content: decode__default.default(templatedAttributes.html) };
      const bufferPDF = await html_to_pdf__default.default.generatePdf(files, options2);
      return bufferPDF;
    } catch (error) {
